...
namespace L12_FAGA_1088322
{
    class PruebaVector2
    {
        ...
        public void CalcularPromedio()
        {
            ...
            promedio = suma / 15;
            Console.WriteLine("El promedio total de las notas es:" + promedio);
        }
        ...
        public void CALCULOMAYORES()
        {
            ...
            Console.WriteLine("Personas mayores al promedio:" + mayor);
            Console.WriteLine("Personas menores al promedio:" + menor);
            Console.ReadKey();
        }
